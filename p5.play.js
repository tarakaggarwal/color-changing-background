...
function Sprite(pInst, _x, _y, _w, _h) {
  ...
  */
   ...
   * @method _collideWith
   * @private
   * @param {string} type - 'overlap', 'bounceOff', 'displace', 'collide',
   *   'bounce' or 'bounceOff'
   * @param {Sprite|Group} target
   * @param {function} callback - if collision occurred (ignored for 'bounceOff')
  ...
  this._collideWithOne = function(type, other, callback) {
    ...
    // Finally, for all collision types except 'bounceOff', call the callback
    // and record that collision occurred.
    if (typeof callback === 'function' && type !== 'bounceOff') {
